...
| --- | --- | --- |
| Deterministic quaternionic explanation | 36/36 frozen records produced byte-identical JSON and technical text across five runs | supported within frozen workflow |
| Qiskit mathematical compatibility | maximum operator, reconstruction, statevector, or probability error `7.22e-16` | supported within frozen workflow |
| Explanatory coverage | all complete 1Q and 2Q records included their required sections; all boundary records marked missing geometry explicitly | supported within frozen workflow |
